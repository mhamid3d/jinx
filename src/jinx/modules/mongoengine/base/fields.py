...
class BaseField(object):
    ...
    def __init__(self, db_field=None, name=None, required=False, default=None,
                 ...
                 dispName=None, visible=True, icon=None, doc=None, **kwargs):
        """
    ...
    def dataType(self):
        #TODO: should set a enum value to each field intead of getting the class name
        field_type = self.__class__.__name__
        for type in mongoengine.fields.__all__:
            if field_type == type:
                return str(type)

        raise(ValueError, "Data Type {} is not a valid type".format(field_type))
    ...
    def __repr__(self):
        ...
        reprstring = re.sub("object at", "object ({}) at".format(self.db_name()), reprstring)
        reprstring = reprstring.replace("mongoengine.fields.", "")
